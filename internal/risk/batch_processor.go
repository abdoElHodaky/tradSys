...
func (s *Service) checkRiskLimitsInternal(userID, symbol string, orderSize, currentPrice float64) *RiskCheckResult {
	...
	var currentPosition *riskengine.Position
...
func (s *Service) checkSingleLimit(limit *RiskLimit, position *riskengine.Position, orderSize, currentPrice float64) string {
	switch limit.Type {
