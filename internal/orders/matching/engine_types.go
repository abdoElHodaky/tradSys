...
// EngineConfig contains configuration for the standard engine
type EngineConfig struct {
	// TradeChannelBuffer is the buffer size for the trade channel
	TradeChannelBuffer int `json:"trade_channel_buffer"`
	// EnableStopOrders enables stop order functionality
	EnableStopOrders bool `json:"enable_stop_orders"`
	// EnableLogging enables trade logging
	EnableLogging bool `json:"enable_logging"`
	// MaxOrdersPerSymbol limits orders per symbol
