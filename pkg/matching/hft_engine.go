...
// This extends the base Order type with HFT-specific fields
type HFTOrder struct {
	*types.Order
	
	// Fixed-point representation for performance
	PriceFixed    uint64 // Fixed-point price representation
	QuantityFixed uint64 // Fixed-point quantity representation
	FilledFixed   uint64 // Fixed-point filled representation
...
// Note: Type aliases and constants are defined in engine.go

// Note: Trade struct is defined in engine.go
